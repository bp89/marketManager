    ...
    <div class="container-fluid col-lg-12 text-left ">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-3 modules-item contacts smallBorder">
                ...
                <ul class="list-unstyled">
                    <a href = "#"><li> - Configure Contact Category</li></a>
                    <a href = "#"><li> - Configure Contact Type</li></a>
                    <a href = "#"><li> - Configure Contact Source</li></a>
                    <a href = "#"><li> - Configure Custom Contact Fields</li></a>
                </ul>
